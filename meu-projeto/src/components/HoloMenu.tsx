...
const RectangleFill = ({ scrollProgress }: { scrollProgress: number }) => {
...
const MenuButton = ({ label, onClick, position, isHovered, onPointerEnter, onPointerLeave }: any) => {
    return (
        <mesh
            position={position}
            onClick={onClick}
...
const Menu: React.FC = () => {
    ...
    const handlePointerEnter = (button: string) => {
